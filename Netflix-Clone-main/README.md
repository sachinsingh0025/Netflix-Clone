...
```bash
git remote add upstream https://github.com/sachinsingh0025/Netflix-Clone.git
```
...
[![built with love](https://forthebadge.com/images/badges/built-with-love.svg)](https://github.com/sachinsingh0025/Netflix-Clone)
